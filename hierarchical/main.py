...
from seq2seq.trainer import SupervisedTrainer, SpkTrainer
from seq2seq.models import EncoderRNN, ContextRNN, SpkDecoderRNN,  Seq2seq, HierSeq2seq, DecoderRNN
...
parser.add_argument('--input_dropout_p', type=float, default=0.8,
                    help='define the probability of dropout')
# define log
...
def init_model():
    if args.load_checkpoint is not None:
        ...
        encoder = EncoderRNN(vocab_size=len(input_vocab),
                             ...
                             # vectors=input_vocab.vectors,
                             vectors=None,
                             hidden_size=args.hidden_size,
                             bidirectional=args.bidirectional,
                             variable_lengths=True)
        context = ContextRNN(vocab_size=len(input_vocab),
                             max_len=args.max_len,
                             # vectors=input_vocab.vectors,
                             vectors=None,
                             hidden_size=args.hidden_size,
        ...
        model = HierSeq2seq(encoder, context, decoder)
